    ...
    public class NT_helper
    {
        ...
        public void Set_border_toCell_selecction(DataGridView dataGridView1, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (e.ColumnIndex > -1 & e.RowIndex > -1)
            {
                ...
                //using (var gridlinePen = new Pen(Color.Blue, 1))
                ...
                using (var selectedPen = new Pen(Color.Blue, 1))
                {
                    ...
                    if (dataGridView1[e.ColumnIndex, e.RowIndex].Selected)
                    {
                        ...
                        e.Graphics.DrawRectangle(selectedPen, new Rectangle(e.CellBounds.Left, e.CellBounds.Top, e.CellBounds.Width , e.CellBounds.Height -1));
