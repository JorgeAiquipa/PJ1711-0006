...
namespace Win32dtug
{
    public class DT_R31
    {
        ...
        public ET_entidad set_001(ET_R31 objEntity)
        {
            ...
            using (SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["SGAP.Properties.Settings.ConectionString"].ToString()))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add("@p_TR31_TR27_ID", SqlDbType.VarChar, 10).Value = objEntity._TR31_TR27_ID;
                    cmd.Parameters.Add("@p_TR31_TR28_ID", SqlDbType.VarChar, 300).Value = objEntity._TR31_TR28_ID;
                    cmd.Parameters.Add("@p_TR31_CANT_PERSONAS", SqlDbType.VarChar, 300).Value = objEntity._TR31_CANT_PERSONAS;
                    cmd.Parameters.Add("@p_TR31_DESCRIP", SqlDbType.VarChar, 300).Value = objEntity._TR31_DESCRIP;
                    cmd.Parameters.Add("@p_TR30_TM2_ID", SqlDbType.VarChar, 10).Value = _global._TM2_ID;
                    cmd.Parameters.Add("@p_TR31_UCREA", SqlDbType.VarChar, 10).Value = _global._U_CREA;
        ...
        ////OBTENER LISTA DE SERVICIOS DE MANO DE OBRA
        //public ET_entidad sel_001(string _TR28_TM39_ID, string _TM2_ID)
        //{
        //    string Mensaje_error = "";
