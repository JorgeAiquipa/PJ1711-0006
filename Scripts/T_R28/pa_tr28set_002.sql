IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[pa_tr28set_002]') AND type in (N'P', N'PC')) --#1
Drop procedure [dbo].pa_tr28set_002;
GO

-- =============================================
-- Author:		cesar.freitas
-- Create date: 2017.12.15
-- Descripcion : Insertamos el servicio hijo asociado a una cotizacion
-- =============================================
CREATE PROCEDURE pa_tr28set_002
		 @p_TR28_PADRE int --ID SERVICIO PADRE EL PRINCIPAL
